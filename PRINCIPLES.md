...
Thirty universal principles, adapted for modern codebases. They are refactoring targets, not upfront mandates — apply them when you notice friction, not as a checklist (see #30).

When reviewing or generating code in this repository, prefer these over personal style.
